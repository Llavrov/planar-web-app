...
const PLATFORM_CARDS: TPlatformCardArray = [
  ...
  },
  {
    ...
    description: (
      <>
        If you have rainbow, trust
        <br /> wallet or other wallet on
        <br /> your phone, click here
      </>
    ),
...
export function PlatformCardsModalContent() {
  return (
    <BaseModal
      ...
      description={
        "You need to connect your Web3 wallet to access the swap features"
      }
